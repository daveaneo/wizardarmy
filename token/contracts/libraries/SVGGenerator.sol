...
//        string memory svg = '<svg width="500" height="500" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">';
        string memory svg = "<svg width='600' height='600' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink'>";

//        CommonDefinitions.ELEMENT magicGene  = GeneLogic.getMagicGenes(_wizardId, wizardSalt);
        uint8[13] memory basicGenes  = GeneLogic.getBasicGenes(_wizardId, wizardSalt);
        string memory magicLetter = GeneLogic.getMagicGenesString(_wizardId, wizardSalt);
...
//        ];
        ...
        for (uint i = 0; i < 13; i++) {
//            svg = string(abi.encodePacked(svg, "<image x='0' y='0' width='600' height='600' xlink:href='data:image/png;base64,", imageBaseURI, "/", magicLetter, "/", Strings.toString(i), "/", Strings.toString(basicGenes[i]), ".png' />"));
            svg = string(abi.encodePacked(svg, "<image x='0' y='0' width='600' height='600' href='", imageBaseURI, "/", magicLetter, "/", Strings.toString(i), "/", Strings.toString(basicGenes[i]), ".png' />"));
        }
