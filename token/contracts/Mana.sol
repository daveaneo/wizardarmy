...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "MANA TOKEN";
    string internal constant SYMBOL = "MANA";
    ...
    uint256 internal constant TOTAL_SUPPLY = 20 * ZEROES;
    ...
    // todo -- It might be beneficial to have this updateable
    ...
    function _addFees() private {
        ...
        // _addFee(FeeType.Burn, 10, burnAddress ); //No burning tokens for now on EVE Token
...
abstract contract BaseRfiToken is IERC20, IERC20Metadata, Ownable, Presaleable, Tokenomics {
    ...
    /** Functions required by IERC20 **/
        ...
        function transferFrom(address sender, address recipient, uint256 amount) external override returns (bool){
            require(!(_isBlacklisted[sender]) && !(_isBlacklisted[recipient]), "Address is blacklisted");
    ...
    function burn(uint256 amount) external {
     ...
     /*@dev @facundo here i implement the blacklisting functions*/
    ...
    function increaseAllowance(address spender, uint256 addedValue) public virtual returns (bool) {
        require(!(_isBlacklisted[spender]), "Address is blacklisted");
...
abstract contract Liquifier is Ownable, Manageable {
    ...
    // PancakeSwap V1
    // address private _mainnetRouterV1Address = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    // PancakeSwap V2
    ...
    function initializeLiquiditySwapper(address routerAddress, uint256 maxTx, uint256 liquifyAmount) internal {
...
abstract contract SafeToken is BaseRfiToken, Liquifier, Antiwhale {
    ...
    constructor(address _routerAddress){
        ...
        initializeLiquiditySwapper(_routerAddress, maxTransactionAmount, numberOfTokensToSwapToLiquidity);
...
contract EveTokenized is SafeToken{

    constructor(address routerAddress) SafeToken(routerAddress){
